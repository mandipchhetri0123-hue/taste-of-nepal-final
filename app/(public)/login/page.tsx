...
export default function LoginPage() {
  ...
  const handleLogin = async (e: any) => {
    ...
    try {
      ...
      const firstName = userDoc.exists() ? userDoc.data().firstName : 'Customer';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="bg-white shadow-xl p-8 rounded-lg w-full max-w-md">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button className="w-full bg-red-600 text-white py-3 rounded font-semibold hover:bg-red-700 transition">Login</button>
        </form>
